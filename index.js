...
const siralisayilar = besYuzdenKucukSayilar.sort((a,b) => {
    return a - b ;
  });
...
const sayiSayilar =  {};
  ...
  for(const sayi in sayiSayilar) {
    if (sayiSayilar[sayi] > 1) {
      tekraredensayilar.push(`${sayi} sayısı ${sayiSayilar[sayi]} kere tekrar edilmiştir.`);
    }
  }
